...
/*
* Instructions:
*   Compile with   `gcc -O2 -fopenmp p3_task2.c -o p3_task2`
*   Run with       `./p3_task2`
*/
...
work(void)
{
	...
	for (k = 0; k < N; k++) {
		...
		// The iteration variable j is kept private for each thread.
		...
		// The iteration variables i and j are kept private for each thread.
